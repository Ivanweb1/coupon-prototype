...
window.LK_STATUSES = {
  draft:      { label: "Черновик",     hint: "Не опубликован, виден только вам" },
  moderation: { label: "На модерации", hint: "Проверяем перед публикацией" },
  live:       { label: "Опубликован",  hint: "Виден в ленте города" },
  done:       { label: "Завершён",     hint: "Срок действия закончился" },
  rejected:   { label: "Отклонён",     hint: "Нужны правки — причина в карточке" }
};
...
window.LK_METRICS = [
  { id: "shown",  label: "Показы",        hint: "Карточка попала на экран посетителя" },
  { id: "opened", label: "Просмотры",     hint: "Купон раскрыли — попап или страница" },
  { id: "taken",  label: "Купон забрали", hint: "Нажали «Забрать купон» и увидели код" },
  { id: "clicks", label: "Переходы к вам", hint: "Клики по сайту и соцсетям компании" }
];
...
/* Бонусы, которые партнёр раздаёт своим клиентам. На созвоне 04.09 это
   ...
   механики в структуре — «От души брат». */
