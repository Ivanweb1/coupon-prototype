...
/* Заливка круга — серый в половину силы (правка Ивана 22.09.2026):
   обводки у круга больше нет, форму держит сама заливка, а прозрачность
   не даёт ей спорить со знаком внутри. */
const CAT_TONES_MONO = ["rgba(211,211,211,.5)", "#DD443C"];
